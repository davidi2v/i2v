...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Fincancial Managment | Invent2Vision Services</title>
...
<section>
    ...
    <div class="container service">
        <img src="../img/gif/financial-management.gif">
        <h1>Fincancial Managment</h1>
        <p class="text">The Financial team can maximize the return on financial assets by establishing and enforcing financial policies, procedures, controls, and reporting systems. We help guide you with your financial decisions by establishing and monitoring all procedures by preparing budgets, schedules, analyzing, consolidating financial data, followed by recommending plans.</p>
    </div>
    <?php
    // endif;
    ?>

...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>Manufacturing | Invent2Vision Services</title>
...
<section>
    ...
    <div class="container service">
        <img src="../img/gif/manufacturing.gif">
        <h1>Manufacturing</h1>
        <p class="text">We are able to provide everything from prototype to production, with full-service manufacturing for a wide array of industries. We are available to provide you with samples, assembly, engineering expertise and testing to ensure you will receive high quality products and services.</p>
    </div>
    <?php
    // endif;
    ?>
